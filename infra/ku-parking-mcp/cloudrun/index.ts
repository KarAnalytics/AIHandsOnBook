...
//     https://ku-parking-mcp-<hash>-uc.a.run.app
...
//
// Cloud Run injects the PORT env var (default 8080) and sends all HTTP traffic
// to that port. We bind to 0.0.0.0 so the container accepts external traffic.
// -----------------------------------------------------------------------------

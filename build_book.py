...
- The same tools are deployed to a **Google Cloud Run** container as an MCP server
...
- **MCP tools** — tools accessed over HTTPS from the Cloud Run endpoint
""",
...
- **MCP on Cloud Run** — deploy tools as a container on Google Cloud Run that any MCP client can call over HTTPS
...
""",
    ...
    "chapters/deployment/mcp_cloudrun.md": """# MCP Servers on Google Cloud Run
